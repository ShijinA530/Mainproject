...
function Voter() {
  ...
  return (
    <div className="mt-5 max-w-[90%] flex flex-col items-center h-screen bg-teal">
      ...
      <div className="max-w-[80%] m-auto p-10 bg-blue-200 rounded-md hover:shadow-lg mt-16 mb-8">
        <label htmlFor="fileInput" className="bg-green-500 text-white py-2 px-4 rounded-md cursor-pointer">Choose Excel File</label>
